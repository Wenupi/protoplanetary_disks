...
inc = 0.                        #deg (disk inclination between 0 and 90 degrees)  #SE PUEDE CAMBIAR 
distance = 120.                  #pc  (disk distance)  #SE PUEDE CAMBIAR 
...
#Convolution
beam = 0.05                       #arcsec  #SE PUEDE CAMBIAR # 0.05
